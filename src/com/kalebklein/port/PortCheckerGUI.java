...
public class PortCheckerGUI extends JFrame
{
	...
	private class ActionHandler implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent e)
		{
			...
			{
				String message = String.format("A simple port checker written in Java\n"
								+ "(c) 2014 Kaleb Klein. All Rights Reserved.\n\n"
								+ "Version: %s\n"
								+ "Build: %s",
								Main.VERSION,
								Main.VERSION_CODE);

				JOptionPane.showMessageDialog(context, message, "About", JOptionPane.PLAIN_MESSAGE);
			}
